    ...
    return (
      ...
      >
        ...
        >
          ...
          <li><a href="https://mindpumpmedia.com">Mind Pump Media</a></li>
          {close}
        </article>
        ...
        >
          ...
          <p>
            Some of my interests besides work/entreprenuership are:
            <li>
              Working out
            </li>
            <li>
        ...
        >
          ...
          <ul className="icons">
            <li>
              <a
                href="https://twitter.com/coglitore_enzo"
            ...
            <li>
              <a href="https://facebook.com/enzocoglitore" className="icon fa-facebook">
                <span className="label">Facebook</span>
              </a>
            </li>
            <li>
              <a href="https://instagram.com/enzocog" className="icon fa-instagram">
                <span className="label">Instagram</span>
              </a>
            </li>
            <li>
              <a
                href="https://github.com/enzocog"
